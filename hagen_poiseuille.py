import sys;  
from simple_navier_stokes import simple_navier_stokes, hagen_poiseuille; 
import numpy as np;
...
file_name = "data/hagen_poiseuille/";
 
sns = hagen_poiseuille.hagen_poiseuille(file_name);

parser = argparse.ArgumentParser(prog="python cylinder.py",
  description = "Initialises and configures a simple navier stokes solver for the Hagen-Poiseuille profile.");
